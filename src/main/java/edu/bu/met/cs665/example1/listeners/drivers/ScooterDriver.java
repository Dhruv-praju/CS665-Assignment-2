 ...
 * Description:  Represents a Scooter driver who can handle delivery request updates.
...
public class ScooterDriver implements Driver {
    ...
    /**
     * The name of the scooter driver.
     */
    private String name;
    ...
    /**
     * Constructs a new ScooterDriver object with the specified name.
     *
    ...
    public void update(DeliveryRequest dr){
        System.out.println(this.name + " scooter driver is notified for the delivery of "
